...
const seedDefaultCategories = async () => {
  try {
    ...
    if (count === 0) {
      ...
      const defaults = [
        { name: 'Custom T-Shirts', slug: 'T-shirt', image: 'https://images.unsplash.com/photo-1521572267360-ee0c2909d518?w=500&auto=format&fit=crop', order: 0, isActive: true },
        { name: 'Polo Shirts', slug: 'Polo', image: 'https://images.unsplash.com/photo-1581655353564-df123a1eb820?w=500&auto=format&fit=crop', order: 1, isActive: true },
        { name: 'Casual Shirts', slug: 'Shirt', image: 'https://images.unsplash.com/photo-1596755094514-f87e34085b2c?w=500&auto=format&fit=crop', order: 2, isActive: true },
        { name: 'Traditional Panjabi', slug: 'Panjabi', image: 'https://images.unsplash.com/photo-1608748010899-18f300247112?w=500&auto=format&fit=crop', order: 3, isActive: true }
      ];
